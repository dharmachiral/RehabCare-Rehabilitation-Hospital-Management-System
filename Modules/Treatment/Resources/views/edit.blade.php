                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('treatment.index') }}">Home</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="product-form" action="{{ route('treatment.update',$treatment->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                    placeholder="Enter Title "value="{{ $treatment->title }}" required>
                                                @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_title" class="form-control"
                                                placeholder="Enter sub Title "value="{{ $treatment->sub_title }}" required>
                                            @error('sub_title')
                                                <p style="color: red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="short_description" class="summernote" placeholder="Enter Short Description" required>{{ $treatment->short_description }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="summernote" placeholder="Enter Short description">{{ $treatment->description  }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/treatment/'.$treatment->image) }}" width="200px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
