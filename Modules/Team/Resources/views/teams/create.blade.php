                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="facebook" class="form-control" placeholder="Enter facebook" value="{{old('facebook')}}" required>
                                        @error('facebook')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="twitter" class="form-control" placeholder="Enter twitter" value="{{old('twitter')}}" required>
                                        @error('twitter')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tiktok" class="form-control" placeholder="Enter tiktok" value="{{old('tiktok')}}" required>
                                        @error('tiktok')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="instagram" class="form-control" placeholder="Enter instagram" value="{{old('instagram')}}" required>
                                        @error('instagram')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="linkedin" class="form-control" placeholder="Enter linkedin" value="{{old('linkedin')}}" required>
                                        @error('linkedin')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
