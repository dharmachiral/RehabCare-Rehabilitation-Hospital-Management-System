                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="introduction">About Us-Title</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="mission">About Us-Sub Content</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="vision">About Us-Full Content</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="footer_text">Holistic Healing Approach</label>
